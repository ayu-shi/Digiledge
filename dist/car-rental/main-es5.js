...
var AddThiefComponent = /** @class */ (function () {
    function AddThiefComponent(fb, bs) {
        this.fb = fb;
        this.bs = bs;
        this.createForm();
    }
    AddThiefComponent.prototype.createForm = function () {
    ...
    AddThiefComponent.prototype.addthief = function (Name, City, Crime) {
        this.bs.addthief(Name, City, Crime);
        this.angForm.reset();
    };
    AddThiefComponent.prototype.ngOnInit = function () {
    };
    AddThiefComponent.ctorParameters = function () { return [
...
var BusinessService = /** @class */ (function () {
    ...
    BusinessService.prototype.addthief = function (Name, City, Crime) {
        var obj = {
            Name: Name,
            City: City,
            Crime: Crime
        ...
        this.http.post(this.uri + "/add", obj)
            .subscribe(function (res) { return alert('Congratulations, New Thief is Added'); });
    };
    BusinessService.prototype.getthief = function () {
        return this
            .http
            .get("" + this.uri);
    };
    BusinessService.prototype.editthief = function (id) {
        return this
            .http
            .get(this.uri + "/edit/" + id);
    };
    BusinessService.prototype.updatethief = function (Name, City, Crime, id) {
        var obj = {
            Name: Name,
            City: City,
            Crime: Crime
    ...
    BusinessService.prototype.deletethief = function (id) {
        return this
            .http
...
var GetThiefComponent = /** @class */ (function () {
    function GetThiefComponent(bs, router) {
        this.bs = bs;
        this.router = router;
    }
    GetThiefComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.bs
            .getthief()
    ...
    GetThiefComponent.ctorParameters = function () { return [
...
var ThiefEditComponent = /** @class */ (function () {
    function ThiefEditComponent(route, router, bs, fb) {
        this.route = route;
        this.router = router;
        this.bs = bs;
        this.fb = fb;
    ...
    ThiefEditComponent.prototype.createForm = function () {
        this.angForm = this.fb.group({
    ...
    ThiefEditComponent.prototype.updatethief = function (Name, City, Crime) {
        var _this = this;
        this.route.params.subscribe(function (params) {
            _this.bs.updatethief(Name, City, Crime, params['id']);
            _this.router.navigate(['thief']);
        });
    };
    ThiefEditComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params.subscribe(function (params) {
            _this.bs.editthief(params['id']).subscribe(function (res) {
                _this.business = res;
                console.log(_this.business);
            });
        });
    };
    ThiefEditComponent.ctorParameters = function () { return [
...
var UpdateDeleteThiefComponent = /** @class */ (function () {
    function UpdateDeleteThiefComponent(bs, router) {
        this.bs = bs;
        this.router = router;
    }
    UpdateDeleteThiefComponent.prototype.deletethief = function (id) {
        var _this = this;
        this.bs.deletethief(id).subscribe(function (res) {
            alert('Thief Deleted');
            _this.router.navigateByUrl('/thief/create');
        });
    };
    UpdateDeleteThiefComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.bs
            .getthief()
            .subscribe(function (data) {
    ...
    UpdateDeleteThiefComponent.ctorParameters = function () { return [
        { type: _business_service__WEBPACK_IMPORTED_MODULE_2__["BusinessService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
    ...
    return UpdateDeleteThiefComponent;
}());
